...
//! This class in intended to be an outline of applications utilizing the
//! DFRCore package. The basic building blocks for the simulation are provided,
//! but the user is expected to customize the application for their specific needs.
