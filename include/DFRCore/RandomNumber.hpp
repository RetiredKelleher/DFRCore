...
//! @brief DFR::RandomNumber class definition, providing random number generation functionality for the DFRCore framework.
...
//! @brief DFRRandomNumber is a utility class that provides random number generation functionality for the DFRCore framework. It encapsulates a random number generator and provides methods for generating random numbers of various types and distributions.
class RandomNumber
{
public:
    //! @brief Constructs a DFRRandomNumber instance with an optional seed for reproducibility.
    //! @param[in] seed An optional seed for the random number generator. If not provided, a random seed will be used.
    ...
    //! @param[in] seed The seed value to set for the random number generator.
    ...
    //! @param[in] min The minimum value of the range (inclusive).
    //! @param[in] max The maximum value of the range (exclusive).
